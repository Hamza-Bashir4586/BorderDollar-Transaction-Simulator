...
contract Tethercoin{
    ...
    // brings up the aggreifator
     AggregatorV3Interface internal priceFeed;

    //Mapping to store balances of each address
    mapping(address => uint256) public balances;

    // Variable to store the total supply of the Tethercoin
...
// MINTING Function
    ...
    //Function to mint new tethercoins
...
// Function to transfer tethercoins
